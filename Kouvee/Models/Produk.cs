...
namespace Kouvee.Models
{
    public class Produk
    {
        ...
        public Produk(string nama_Produk, int stock, int min_Stock, string satuan_Produk, int harga_BeliProduk, int harga_JualProduk, byte[] gambar_Blob, int iD_Pegawai)
        {
            ...
            Gambar_Blob = gambar_Blob;
            ID_Pegawai = iD_Pegawai;
        }

        public Produk(int iD_Produk, string nama_Produk, int stock, int min_Stock, string satuan_Produk, int harga_BeliProduk, int harga_JualProduk, byte[] gambar_Blob, int iD_Pegawai, DateTime create_At_Produk, DateTime update_At_Produk, DateTime delete_At_Produk)
        {
            ID_Produk = iD_Produk;
            Nama_Produk = nama_Produk;
            Stock = stock;
        ...
        public byte[] Gambar_Blob { get; set; }
