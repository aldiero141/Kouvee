...
{
    public partial class FormTambahTransaksiLayanan : Form
    {
        public FormTambahTransaksiLayanan()
        {
            InitializeComponent();
        }

        private void FormTambahTransaksiLayanan_Load(object sender, EventArgs e)
        {
